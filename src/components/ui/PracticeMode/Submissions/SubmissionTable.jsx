            ...
            <Table.Root variant='ghost'>
                <Table.Header>
                    <Table.Row>
                        ...
                        <Table.ColumnHeaderCell justify={'center'}>Approved</Table.ColumnHeaderCell>
                        <Table.ColumnHeaderCell justify={'center'}>Pending</Table.ColumnHeaderCell>
                ...
                <Table.Body>
                    {tableData.map((task) => (
                        <Table.Row key={task.title} align={'center'}>
                            ...
                            <Table.Cell justify={'center'}>23</Table.Cell>
                            <Table.Cell justify={'center'}>
                                <Text color={'green'}>5</Text>
                            </Table.Cell>
                            <Table.Cell justify={'center'}>
                                <Text color={'red'}>18</Text>
                            </Table.Cell>
